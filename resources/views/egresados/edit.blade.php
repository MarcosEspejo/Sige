                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="primer_nombre" id="primer_nombre" 
                               value="{{ old('primer_nombre', $egresado->primer_nombre) }}" required 
                    ...
                    <div>
                        ...
                        <input type="text" name="segundo_nombre" id="segundo_nombre" 
                               value="{{ old('segundo_nombre', $egresado->segundo_nombre) }}" 
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-libertadores-green focus:ring-libertadores-green">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="primer_apellido" id="primer_apellido" 
                               value="{{ old('primer_apellido', $egresado->primer_apellido) }}" required 
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-libertadores-green focus:ring-libertadores-green">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="segundo_apellido" id="segundo_apellido" 
                               value="{{ old('segundo_apellido', $egresado->segundo_apellido) }}" 
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-libertadores-green focus:ring-libertadores-green">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="documento" id="documento" 
                               value="{{ old('documento', $egresado->documento) }}" required 
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-libertadores-green focus:ring-libertadores-green">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="email" name="email" id="email" 
                               value="{{ old('email', $egresado->email) }}" required 
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-libertadores-green focus:ring-libertadores-green">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" name="fecha_nacimiento" id="fecha_nacimiento" 
                               value="{{ old('fecha_nacimiento', $egresado->fecha_nacimiento) }}" required 
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-libertadores-green focus:ring-libertadores-green">
                    </div>
                </div>
            </div>
